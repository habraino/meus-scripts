...
def getRandomizedBoard():
    ...
    randonTest.shuffle(icons)  # randomize the order of the icons list
    numIconsUsed = int(BOARDWIDTH * BOARDHEIGHT / 2)  # calculate how many icons are needed
    icons = icons[:numIconsUsed] * 2  # make two of each
    randonTest.shuffle(icons)
...
def drawIcon(shape, color, boxx, boxy):
    ...
    left, top = leftTopCoordsOfBox(boxx, boxy) # get pixel coords from board coords Draw the shapes
    if shape == DONUT:
